...
<template>
    <div :class="{ 'horizontal': store.menu }">
        <div class="shadow-sm">
            <!-- horizontal menu -->
            <ul class="horizontal-menu py-1.5 font-semibold px-6 lg:space-x-1.5 xl:space-x-8 rtl:space-x-reverse bg-white border-t border-[#ebedf2] dark:border-[#191e3a] dark:bg-[#0e1726] text-black dark:text-white-dark">
                <li class="menu nav-item relative">
                    <Link :href="'/employee_dashboard'" class="nav-link">
                ...
                <li class="menu nav-item relative">
                    <Link :href="'/induction'" class="nav-link">
                        <div class="flex items-center">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="shrink-0">
                                <g opacity="0.5">
                                    <path
                ...
                <li class="menu nav-item relative">
                    <Link :href="'/contacts'" class="nav-link">
                        <div class="flex items-center">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="shrink-0">
                                <path
