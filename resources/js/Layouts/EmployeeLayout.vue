<template>
<div
        class="main-section antialiased relative font-nunito text-sm font-normal toggle-sidebar vertical full ltr"       
    >
    <!--  BEGIN MAIN CONTAINER  -->
    <div class="relative">
        <div class="fixed inset-0 bg-[black]/60 z-50 lg:hidden hidden"></div>    
