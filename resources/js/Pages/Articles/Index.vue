...
<template>
  <App>
    <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
      <header>
        <h5 class="font-semibold text-lg dark:text-white-light">Article</h5>
      </header> <br>
      <div class="grid justify-items-stretch grid-cols-2 gap-4">
        ...
        <div class="justify-self-end">
          <Link :href="'/articles/create'" class="btn btn-primary btn-sm " v-if="can">
    ...
    <div class="table-responsive">
      <table>
        <thead>
          ...
          <tbody v-for="(article, index) in articles.data">
            <tr>
              <td>{{ index + 1 }}</td>
              <td>{{ article.topic }}</td>
              ...
              <td style="float: right;">
                <div class="flex gap-4">
                  <div v-if="article.canEdit">
                    <Link :href="'/articles/' + article.id + '/edit'" method="get" v-tippy:edit>
                  ...
                  <div v-if="article.delete">
                    <Link :href="'/articles/' + article.id" method="delete"  as="button" v-tippy:delete>
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                        class="w-5 h-5">
