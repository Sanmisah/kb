...
<template>
  <App>
    <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
      <header>
        <h5 class="font-semibold text-lg dark:text-white-light">Notice</h5>
      </header> <br>
      <div class="grid justify-items-stretch grid-cols-2 gap-4">
        ...
        <div class="justify-self-end">
          <Link :href="'/notices/create'" class="btn btn-primary btn-sm " v-if="can">
    ...
    <div class="table-responsive">
      <table>
        <thead>
          ...
          <tbody v-for="(notice, index) in notices.data">
            <tr>
              <td>{{ index + 1 }}</td>
              ...
              <td style="float: right;">
                <div class="flex gap-4">
                  <div v-if="notice.canEdit">
                    <Link :href="'/notices/' + notice.id + '/edit'" method="get" v-tippy:edit>
                  ...
                  <div v-if="notice.delete">
                    <Link :href="'/notices/' + notice.id" method="delete"  as="button" v-tippy:delete>
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                        class="w-5 h-5">
                  ...
                  <!-- <a :href="'/notices/export'"  v-tippy:make target="_blank">
