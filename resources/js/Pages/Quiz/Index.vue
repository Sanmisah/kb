    ...
    <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
      ...
      <div class="grid justify-items-stretch grid-cols-2 gap-4">
        ...
        <div class="justify-self-end">
          <Link :href="'/quiz/create'" class="btn btn-primary btn-sm " v-if="can">
    ...
    <div class="table-responsive">
      <table>
        <thead>
          ...
          <tbody v-for="(val, index) in quiz.data">
            <tr>
              <td>{{ index + 1 }}</td>
              <td>{{ val.question }}</td>
              <td>{{ val.type }}</td>
              <td style="float: right;">
                <div class="flex gap-4">
                  <div v-if="val.canEdit">
                    <Link :href="'/quiz/' + val.id + '/edit'" method="get" v-tippy:edit>
                  ...
                  <div v-if="val.delete">
                    <Link :href="'/quiz/' + val.id" method="delete"  as="button" v-tippy:delete>
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                        class="w-5 h-5">
