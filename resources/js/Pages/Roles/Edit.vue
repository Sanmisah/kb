                ...
                <form class="space-y-5" @submit.prevent="submit">
                    <div class="grid grid-cols-6 gap-4">
                        <div class="col-start-1 col-end-3">
                            ...
                            <TextInput id="name" type="text" class="form-input" v-model="form.name" :value="role.name" />
                            <br>
                            <div class="mt-2 text-red-500" v-if="errors.name">{{ errors.name }}</div>
                        </div>
                        <div class="col-start-3 col-end-6">
                            ...
                            <br>
                            <div class="mt-2 text-red-500" v-if="errors.guard_name">{{ errors.guard_name }}</div>
                        </div>
