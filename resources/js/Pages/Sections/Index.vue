...
<template>
    <App>      
      <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
          <header>
              <h5 class="font-semibold text-lg dark:text-white-light">Section</h5>
          </header> <br>
          <div class="grid justify-items-stretch grid-cols-2 gap-4">
            ...
            <div class="justify-self-end">
              <Link :href="'/sections/create'" class="btn btn-primary btn-sm ">
                <svg
          ...
          <div class="table-responsive">
            <table>
              ...
              <tbody v-for="(section,index) in sections.data">
                <tr>
                  <td>{{ index+1 }}</td>
                  ...
                  <td style="float: right;">
                    <div class="flex gap-4">
                      ...
                      <Link :href="'/sections/' + section.id " method="delete" v-tippy:delete>
